...
import com.example.bookstore.databinding.ActivityRegistroClienteBinding
...
class RegistroClienteActivity : AppCompatActivity() {
    ...
    private fun RegistroClienteActivity.validarInformacion() {
    ...
    private fun insertarInfoBD() {
        ...
        val reference = FirebaseDatabase.getInstance().getReference("Uusuarios")
        reference.child(uid!!)
